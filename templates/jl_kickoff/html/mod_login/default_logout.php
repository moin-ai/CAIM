...
<?php if ($params->get('greeting', 1)) : ?>
    <div class="mod-login-logout__login-greeting login-greeting jl-margin-small">
...
<?php endif; ?>
    <div class="mod-login-logout__button logout-button">
        <button type="submit" name="Submit" class="jl-button jl-button-primary"><?php echo Text::_('JLOGOUT'); ?></button>
