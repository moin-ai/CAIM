...
<?php if (count($fields)) : ?>
    <fieldset id="users-profile-custom" class="com-users-profile__params jl-fieldset jl-margin">
        <legend class="jl-legend"><?php echo Text::_('COM_USERS_SETTINGS_FIELDSET_LABEL'); ?></legend>
