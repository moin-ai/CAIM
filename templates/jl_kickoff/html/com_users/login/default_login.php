            ...
            <fieldset class="jl-fieldset">
                ...
                <?php foreach ($this->extraButtons as $button) :
                    ...
                    <div class="com-users-login__submit control-group">
                        <div class="controls">
                            <button type="button"
                                    class="jl-button jl-button-secondary jl-width-1-1 <?php echo $button['class'] ?? '' ?>"
