...
return [
    ...
    'filename' => 'E:\\XAMPP\\htdocs\\CAIM2/templates/jl_kickoff/particles/jlopenstreetmap.yaml',
    'modified' => 1686729426,
    'data' => [
        ...
        'form' => [
            ...
            'fields' => [
                    ...
                    'fields' => [
                        '_tab_content' => [
                            ...
                            'fields' => [
                                ...
                                'resize_event' => [
                                    'type' => 'input.checkbox',
                                    'label' => 'Fix Map Resize Event',
                                    'description' => 'If you use preloader atom with the topbar progress indicator is enabled. Check this option to fix the Map tileLayer not resizing correctly.',
                                    'default' => false
                                ],
                                'class' => [
                ...
                'copyright' => [
                    ...
                    'content' => 'JL Open Street Map <strong>Version: 2.2.6</strong> by <a href="https://joomlead.com" target="_blank">Joomlead</a> | <a href="https://joomlead.com/g5/docs/open-street-map-particle/" target="_blank">Documentation</a>'
                ]
            ]
        ]
    ]
